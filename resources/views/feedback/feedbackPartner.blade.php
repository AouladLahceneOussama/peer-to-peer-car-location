        ...
        <div class="flex flex-col shadow-xl w-full">
            <div class="py-6 px-14 bg-gradient-to-tr from-red-600 to-red-400 rounded-tl-2xl rounded-tr-2xl text-center space-y-8">
                ...
                <h4 class="text-white text-left font-bold text-xl">
                    Dear Partner,<br>
                    Thank you for using our online rent service. We would like to know how was the client. Please spare some moments to give us your valuable feedback as it will help us in improving our service.
                </h4>
            </div>
            <form method = "post" action="/feedback/add" class="py-10 px-14 md:px-0 bg-white flex justify-center">
                @csrf
                ...
                <div>
                    ...
                    <div class="w-full mb-4">
                        <x-jet-label for="role" value="{{ __('Rate the client sympathie') }}" class="font-semibold text-black text-lg" />
                    ...
                    <div class="max-w-3xl mb-2">
                        <x-jet-label for="role" value="{{ __('Anything to say about the Client') }}" class="font-semibold text-black text-lg" />
